...
Shader::Shader(const char* vertexPath, const char* fragmentPath)
{
    ...
    // Ensure ifstream object can throw exceptoions:
...
int Shader::setInt(const std::string &name, int value) const
{
    GLint loc = glGetUniformLocation(ID, name.c_str());
    if (GL_INVALID_OPERATION != loc && GL_INVALID_VALUE != loc && loc != -1)
    {

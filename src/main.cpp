...
int main()
{
	/*-----------OpenGL Init and Window creation-------------*/
	...
	//	Set properties for the new buffer. 1. Type 2. Total size 3. Actual data 4.Usage pattern
	...
	// Loop while GLFW isn't instructed to close.
	while (!glfwWindowShouldClose(window))
	{
		...
		//glm::vec3 lightPos = glm::vec3(1.2f * glm::sin(currentFrame), 0.5f, 2.0f * glm::cos(currentFrame));
